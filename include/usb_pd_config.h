...
#if !defined(PD_CONFIG_TARGET_ESP32S3) && !defined(PD_CONFIG_TARGET_ARDUINO) && \
	!defined(PD_CONFIG_TARGET_STM32)
#define PD_CONFIG_TARGET_ESP32S3 (1)
#endif

#ifndef PD_CONFIG_TARGET_ESP32S3
#define PD_CONFIG_TARGET_ESP32S3 (0)
#endif
#ifndef PD_CONFIG_TARGET_ARDUINO
#define PD_CONFIG_TARGET_ARDUINO (0)
#endif
#ifndef PD_CONFIG_TARGET_STM32
#define PD_CONFIG_TARGET_STM32 (0)
#endif

#if (PD_CONFIG_TARGET_ESP32S3 + PD_CONFIG_TARGET_ARDUINO + PD_CONFIG_TARGET_STM32) != 1
#error "Define exactly one PD_CONFIG_TARGET_* platform flag"
#endif
